...
non_ticks1=(ImageView) findViewById(R.id.correctView02);
non_ticks2=(ImageView) findViewById(R.id.correctView03);
non_ticks3=(ImageView) findViewById(R.id.correctView04);
} else {
ticks = (ImageView) findViewById(R.id.wrongView01);
non_ticks1=(ImageView) findViewById(R.id.wrongView03);
non_ticks2=(ImageView) findViewById(R.id.wrongView02);
non_ticks3=(ImageView) findViewById(R.id.wrongView04);
}
break;
case 1:
if (tick) {
ticks = (ImageView) findViewById(R.id.correctView02);
non_ticks1=(ImageView) findViewById(R.id.correctView03);
non_ticks2=(ImageView) findViewById(R.id.correctView01);
non_ticks3=(ImageView) findViewById(R.id.correctView04);
} else {
ticks = (ImageView) findViewById(R.id.wrongView02);
non_ticks1=(ImageView) findViewById(R.id.wrongView01);
non_ticks2=(ImageView) findViewById(R.id.wrongView03);
non_ticks3=(ImageView) findViewById(R.id.wrongView04);
}
break;
case 2:
...
non_ticks1=(ImageView) findViewById(R.id.correctView01);
non_ticks2=(ImageView) findViewById(R.id.correctView02);
non_ticks3=(ImageView) findViewById(R.id.correctView04);
...
non_ticks1=(ImageView) findViewById(R.id.correctView01);
non_ticks2=(ImageView) findViewById(R.id.correctView02);
non_ticks3=(ImageView) findViewById(R.id.correctView03);

} else {
ticks = (ImageView) findViewById(R.id.wrongView04);
non_ticks1=(ImageView) findViewById(R.id.wrongView01);
non_ticks2=(ImageView) findViewById(R.id.wrongView02);
non_ticks3=(ImageView) findViewById(R.id.wrongView03);
    ...
    class UpdateUserScore extends AsyncTask<String, String, String> {
        ...
        if (((GlobalLoginApplication)getApplication()).loginStatus()){
           if(score>currentPlayer.SaveTheeggs){
               currentPlayer.Total+=score-currentPlayer.SaveTheeggs;
